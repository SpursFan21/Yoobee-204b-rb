  ...
  return (
    <>
      <div className="absolute z-20 flex w-full justify-center">
        <nav className="fixed relative mt-8 flex h-20 w-11/12 items-center justify-between rounded-lg border-2 border-zinc-800 bg-zinc-900 px-8 backdrop-blur-lg lg:px-20 xl:w-8/12">
          <Link
            href={"/"}
